...
<div class="container mb-4">
  <div class="card bg-white p-4 border border-primary rounded shadow-lg">
    ...
    <script>
        ...
        // TODO: ADD FUNCTIONALITY FOR EDITING AND DELETING COMMENT BY 
        // USER WHO COMMENTED ON THE JOB
    </script>
    <!-- ===================== -->
    <div class="row ">
      <a href="{{route('welcome' )}}" class="btn btn-primary col-md-1 mx-auto">HOME</a>
    </div>
  </div>
</div>